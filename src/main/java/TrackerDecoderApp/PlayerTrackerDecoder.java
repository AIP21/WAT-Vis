...
import TrackerDecoderApp.ui.ImportForm;
import TrackerDecoderApp.ui.RangedSlider.RangeSlider;
import TrackerDecoderApp.ui.SettingsForm;
...
public class PlayerTrackerDecoder extends JFrame {
    ...
    public PlayerTrackerDecoder(boolean debug) {
        ...
        dataFileImportButton.addActionListener((event) -> {
            ...
            importForm = new ImportForm(this, settings, logger, alreadyImported);
            importForm.setLocationRelativeTo(this);
            importForm.setVisible(true);
        });

        settingsButton = new JMenuItem("");
        settingsButton.setToolTipText("Open TrackerDecoderApp.Settings Pane");
    ...
    private void initMainFrame() {
        ...
        setTitle("Player Tracker TrackerDecoderApp.Decoder App - v" + version);
        ...
        mainPanel.setDropTarget(new DropTarget() {
            public synchronized void drop(DropTargetDropEvent evt) {
                try {
                    ...
                    importForm = new ImportForm(PlayerTrackerDecoder.this, settings, logger, evt, alreadyImported);
    ...
    private void initDataSettingsToolBar(boolean remove) {
        logger.info("Initializing TrackerDecoderApp.ui.toolbar subsystem", 0);
...
//                drawSizeTitle.setEnabled(settings._drawType == TrackerDecoderApp.Decoder.DrawType.Line || settings._drawType == TrackerDecoderApp.Decoder.DrawType.Heat);
//                drawSizeSlider.setEnabled(settings._drawType == TrackerDecoderApp.Decoder.DrawType.Line || settings._drawType == TrackerDecoderApp.Decoder.DrawType.Heat);
//                drawSizeLabel.setEnabled(settings._drawType == TrackerDecoderApp.Decoder.DrawType.Line || settings._drawType == TrackerDecoderApp.Decoder.DrawType.Heat);
//            }
...
//        });
        ...
        logger.info("Successfully initialized TrackerDecoderApp.ui.toolbar subsystem", 1);
    }
